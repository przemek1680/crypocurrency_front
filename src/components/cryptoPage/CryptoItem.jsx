...
const CryptoItem = (props) => {
  ...
  return (
    <Grid container item xs={12} md={10} spacing={0} mt={3} className={classes.crypto}>
        ...
        <Grid item xs={8}>
          <Typography sx={{fontSize: 20, fontSmooth: 50, fontWeight: "medium", fontFamily:"MenschRegular"}} mt={1}>
            {data.CryptoName}
          </Typography>
          <Typography sx={{fontSize: 18, fontSmooth: 50, fontWeight: "medium", letterSpacing: 3, color: "#B6C3D8", fontFamily:"MenschRegular"}} mt={1}>
